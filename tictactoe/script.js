...
function computer()
{
  ...
  {
    setTimeout(function() {document.tic.sqr3.value = " O "
    sqr3T = 1;
    turn = 0;}, 500);
  }
  else if(sqr2 == " X " && sqr3 == " X " && sqr1T == 0 && turn == 1)
  {
    setTimeout(function() {document.tic.sqr1.value = " O "
    sqr1T = 1;
    turn = 0;}, 500);
  }
  else if(sqr4 == " X " && sqr5 == " X " && sqr6T == 0 && turn == 1)
  {
    setTimeout(function() {document.tic.sqr6.value = " O "
    sqr6T = 1;
    turn = 0;}, 500);
  }
  else if(sqr5 == " X " && sqr6 == " X " && sqr4T == 0 && turn == 1)
  {
    setTimeout(function() {document.tic.sqr4.value = " O "
    sqr4T = 1;
    turn = 0;}, 500);
  }
  else if(sqr7 == " X " && sqr8 == " X " && sqr9T == 0 && turn == 1)
  {
    setTimeout(function() {document.tic.sqr9.value = " O "
    sqr9T = 1;
    turn = 0;}, 500);
  }
  else if(sqr8 == " X " && sqr9 == " X " && sqr7T == 0 && turn == 1)
  {
    setTimeout(function() {document.tic.sqr7.value = " O "
    sqr7T = 1;
    turn = 0;}, 500);
  }
  ...
  {
    setTimeout(function() {document.tic.sqr2.value = " O "
    sqr2T = 1;
    turn = 0;}, 500);
  }
  else if(sqr4 == " X " && sqr6 == " X " && sqr5T == 0 && turn == 1)
  {
    setTimeout(function() {document.tic.sqr5.value = " O "
    sqr5T = 1;
    turn = 0;}, 500);
  }
  else if(sqr7 == " X " && sqr9 == " X " && sqr8T == 0 && turn == 1)
  {
    setTimeout(function() {document.tic.sqr8.value = " O "
    sqr8T = 1;
    turn = 0;}, 500);
  }
